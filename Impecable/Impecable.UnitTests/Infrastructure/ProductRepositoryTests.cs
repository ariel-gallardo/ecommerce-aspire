...
using Impecable.Turnos.Infrastructure.Data;
using Impecable.Turnos.Infrastructure.Repositories;
using Microsoft.EntityFrameworkCore;

namespace Impecable.Turnos.UnitTests.Infrastructure
{
    public class ProductRepositoryTests
    {
        ...
        public async Task AddAsync_ShouldAddProductToDatabase()
        {
            ...
            var repository = new TurnosRepository(context);
